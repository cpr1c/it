...
Процедура ОтправитьСообщение(Знач УчетнаяЗапись, Знач ПараметрыОтправки) Экспорт
	...
	Если ПараметрыОтправки.Свойство("ИмяОтправителя") Тогда
		Письмо.ИмяОтправителя              = ПараметрыОтправки.ИмяОтправителя;
		Письмо.Отправитель.ОтображаемоеИмя = ПараметрыОтправки.ИмяОтправителя;
	КонецЕсли;
