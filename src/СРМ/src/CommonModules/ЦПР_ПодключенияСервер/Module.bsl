...
Функция ТекстФайлаПодключениеКУдаленнымРабочимСтолам(СтруктураПараметровПодключения) Экспорт
	...
	Возврат ТекстСохранения.ПолучитьТекст();
КонецФункции
...
Функция ПолучитьДвоичныеДанныеФайлаПодключениеКУдаленнымРабочимСтолам(СтруктураПараметровПодключения) Экспорт
	ТекстСохранения=Новый ТекстовыйДокумент;
	ТекстСохранения.УстановитьТекст(ТекстФайлаПодключениеКУдаленнымРабочимСтолам(СтруктураПараметровПодключения));
	
	ПотокВПамяти = Новый ПотокВПамяти;
	
	ТекстСохранения.Записать(ПотокВПамяти);
...
КонецПроцедуры
Функция ПолучитьУчетныеДанныеПодключенияДляПодключенияБезЛогина(Подключение) Экспорт
