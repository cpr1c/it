...
Функция СтатусЗадачиЗакрыт() Экспорт
	Статусы = СтатусыСписка(Справочники.СпискиСтатусовЗадач.Закрытые);
...
Функция ФорматТекстаКомментарияПоУмолчанию() Экспорт
	Возврат РедакторКомментария.ВидРедактораКомментарияПользователя();
КонецФункции
Функция ВариантСортировкиИсторииЗадачиПользователя() Экспорт
	Возврат УправлениеЗадачами.ВариантСортировкиИсторииЗадачиПользователя();
КонецФункции
