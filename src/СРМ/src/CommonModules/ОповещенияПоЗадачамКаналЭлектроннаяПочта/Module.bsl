...
Функция ТекстКомментарияПреобразованный(Сообщение,КомментарийИзБазы, ДополнительныеПараметры) Экспорт
	Если ДополнительныеПараметры.ФорматКомментария=Перечисления.ВариантыОформленияТекста.Markdown Тогда
		Возврат ДополнительныеПараметры.КомментарийHTML;
	КонецЕсли;
