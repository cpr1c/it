	...
	Если Изменения.Количество() > 0 Тогда
		...
		Для Каждого ТекИзменение Из Изменения Цикл
			ТекстИзменений=ТекстИзменений
						   + "<li>Параметр <strong>"
						   + СтрокаСЭкранированнымиСимволамиHTML(ТекИзменение.Значение.Синоним)
						   + "</strong> изменился с <i>"
						   + СтрокаСЭкранированнымиСимволамиHTML(ТекИзменение.Значение.ПредыдущееЗначение)
						   + "</i> на <i>"
						   + СтрокаСЭкранированнымиСимволамиHTML(ТекИзменение.Значение.Значение)
						   + "</i></li>"
						   + Символы.ПС;
		КонецЦикла;
