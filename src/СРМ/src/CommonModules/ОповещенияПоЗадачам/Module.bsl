...
Процедура ОтправитьОповещение(ИдентификаторТранзакции, Идентификатор, Событие, ИнициаторСобытия) Экспорт
	...
	Если Не МенеджерЗаписи.Выбран() Тогда
		Возврат;
	КонецЕсли;
	ЗаписьЖурналаРегистрации("Задачи.ОтправкаОповещения", УровеньЖурналаРегистрации.Информация, Документы.Задача, МенеджерЗаписи.Задача, "Начало отправки оповещения "+Идентификатор+" по задаче");
	...
	Если ЗначениеЗаполнено(Ошибка) Тогда
		ЗаписьЖурналаРегистрации("Задачи.ОтправкаОповещения", УровеньЖурналаРегистрации.Ошибка, Документы.Задача, МенеджерЗаписи.Задача, "Отправки оповещения "+Идентификатор+" по задаче завершилось с ошибкой "+Ошибка);
	Иначе
		ЗаписьЖурналаРегистрации("Задачи.ОтправкаОповещения", УровеньЖурналаРегистрации.Информация, Документы.Задача, МенеджерЗаписи.Задача, "Окончание отправки оповещения "+Идентификатор+" по задаче");
	КонецЕсли;
КонецПроцедуры
