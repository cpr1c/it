...
Процедура СоздатьНовоеПисьмоПоКомментариюЗадачи(КомментарийЗадачиОбъект) Экспорт
	Формат=РедакторКомментария.ФорматТекстаРедактирования(КомментарийЗадачиОбъект.ТекстСообщенияФормат);
	Если Формат=Перечисления.ВариантыОформленияТекста.Markdown Тогда
		ТекстКомментария=КомментарийЗадачиОбъект.ТекстСообщения;
	Иначе
		ТекстКомментария=КомментарийЗадачиОбъект.ТекстСообщения;
	КонецЕсли;
...
Процедура ОтправитьПисьмоПоКомментариюЗадачи(КомментарийЗадачиОбъект) Экспорт
