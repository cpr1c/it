...
Функция ПолучитьМассивИсторииЗадачи(Задача,ИдентификаторФормы,ДанныеПрисоединенныхФайлов) Экспорт
	...
	|	КомментарииЗадач.ТекстСообщенияHTML КАК ТекстСообщенияHTML
	|ИЗ
	...
	РМ_MarkdownКлиентСервер.СконвертироватьИменаПрисоединенныхФайловВТексте(ДанныеПрисоединенныхФайлов,ТекстСообщения);
	СтруктураЗаписиИстории.Вставить("ТекстСообщения",ТекстСообщения);
	СтруктураЗаписиИстории.Вставить("ТекстСообщенияHTML",Задача.СодержаниеHTML);
	
	//нужно проверить есть что то несконвертированное и отправить на конвертацию
	Если (Не ЗначениеЗаполнено(СтруктураЗаписиИстории.ТекстСообщения) И ЗначениеЗаполнено(СтруктураЗаписиИстории.ТекстСообщенияHTML)) Тогда
		СтруктураЗаписиИстории.ТекстСообщения=СтруктураЗаписиИстории.ТекстСообщенияHTML;
		//Для Каждого Вложение Из ДанныеПрисоединенныхФайлов Цикл
		//	СтруктураЗаписиИстории.ТекстСообщения=СтрЗаменить(СтруктураЗаписиИстории.ТекстСообщения,"cid:"+Строка(Вложение.Ссылка),Вложение.Адрес);
		//	СтруктураЗаписиИстории.ТекстСообщения=СтрЗаменить(СтруктураЗаписиИстории.ТекстСообщения,Строка(Вложение.Ссылка),Вложение.Адрес);
	...
	Пока Выборка.Следующий() Цикл
		...
		СтруктураЗаписиИстории.Вставить("ТекстСообщения",ТекстСообщения);
		СтруктураЗаписиИстории.Вставить("ТекстСообщенияHTML",Выборка.ТекстСообщенияHTML);
		...
		//нужно проверить есть что то несконвертированное и отправить на конвертацию
		Если (Не ЗначениеЗаполнено(СтруктураЗаписиИстории.ТекстСообщения) И ЗначениеЗаполнено(СтруктураЗаписиИстории.ТекстСообщенияHTML)) Тогда
			Для Каждого Вложение Из СтруктураЗаписиИстории.МассивВложений Цикл
				СтруктураЗаписиИстории.ТекстСообщения=СтрЗаменить(СтруктураЗаписиИстории.ТекстСообщенияHTML,"cid:"+Строка(Вложение.Ссылка),Вложение.Адрес);
				//ТекЗапись.ТекстСообщения=СтрЗаменить(ТекЗапись.ТекстСообщения,"cid:"+Строка(Вложение.ИмяФайла),"Адрес");
			КонецЦикла;
		КонецЕсли;
