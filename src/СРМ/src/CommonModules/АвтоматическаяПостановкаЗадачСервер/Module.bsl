...
Процедура СоздатьНовуюЗадачуПоСообщениюЭлектроннойПочты(СообщениеЭлектроннойПочты,НастройкаАвтоматическогоФормированияЗадач)
	...
	НоваяЗадача.Содержание=ТекстСообщенияHTMLЭлектроннойПочтыДляЗадачи(СообщениеЭлектроннойПочты,НастройкаАвтоматическогоФормированияЗадач);
	НоваяЗадача.СодержаниеФормат=Перечисления.ВариантыОформленияТекста.HTML;
...
Процедура ДобавитьКомментарийКЗадачеПоСообщениюЭлектроннойПочты(ТекущаяЗадача,СообщениеЭлектроннойПочты,НастройкаАвтоматическогоФормированияЗадач) 
	...
	НовыйКомментарий.ТекстСообщения=ТекстСообщенияHTMLЭлектроннойПочтыДляЗадачи(СообщениеЭлектроннойПочты,НастройкаАвтоматическогоФормированияЗадач);
	НовыйКомментарий.ТекстСообщенияФормат=Перечисления.ВариантыОформленияТекста.HTML;
