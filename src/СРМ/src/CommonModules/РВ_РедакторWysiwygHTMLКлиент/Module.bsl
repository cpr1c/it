...
Процедура СобытиеПолеРедактированияКомментария(Форма, Событие) Экспорт
	Если Событие.detail.event="uploadFile" Тогда
	...
	ИначеЕсли Событие.detail.event="uploadImage" Тогда
	...
	ИначеЕсли Событие.detail.event="clipImage" Тогда
...
Процедура УстановитьЗначениеПоляРедактированияВРеквизит(Форма, ПутьКДанным) Экспорт
	...
	ТекстКомментария=Форма.Элементы[ИмяЭлементаПоляКоментария].Документ.defaultView.getHtmltext();
...
Процедура ОбновитьПолеРедактированияКомментария(Форма, ПутьКДанным) Экспорт
	...
	Документ.setHtmlText(ТекстДляРедактирования);
	Документ.setBaseURL(ПолучитьНавигационнуюСсылкуИнформационнойБазы()+"/ru");
...
Процедура ВставитьКартинкуВПолеРедактораКомментария(Форма, Адрес, ПутьКДаннымБезЛишнего, ИмяФайла) Экспорт
	...
	Элемент.Документ.defaultView.insertImage(Адрес,ИмяФайла);
КонецПроцедуры
