...
Процедура ОбработатьКомандуУчетаВремениПослеДиалога(РезультатДиалога, ДополнительныеПараметры) Экспорт
	...
	ДанныеТаймераФормы=УчетВремениКлиентСервер.ДанныеТаймераФормы(Форма, Идентификатор);

	Если Действие = "Старт" Тогда
		Если УчетВремениКлиентСервер.ТаймерОстановлен(ДанныеТаймераФормы) Тогда
	...
	ИначеЕсли Действие = "Стоп" Тогда
		Если УчетВремениКлиентСервер.ТаймерАктивен(ДанныеТаймераФормы) Тогда
