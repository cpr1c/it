...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.МенеджерПечати = "Документ.ОтчетПоРаботам";
...
Функция ПечатьОтчетаПоРаботе(МассивОбъектов, ОбъектыПечати)
	...
	Макет=Документы.ОтчетПоРаботам.ПолучитьМакет("ОтчетПоРаботе");
	...
	|	) КАК Задачи
	|ИЗ
	|	Документ.ОтчетПоРаботам КАК ФормированиеЗаказа
	|ГДЕ
