...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	// 17.08.2019 *** ЦПР *** Борисов Проект "Поддержка" Задача № 13291 (начало)
	Если ИмяСобытия = "ВставкаКартинкиИзБуфераОбмена" Тогда
		
		ПолноеИмяФайла = Параметр;
		...
		ДобавитьКартинкуВФорматированныйДокументНаСервере(Картинка);
		УдалитьФайлы(ПолноеИмяФайла);
		
	КонецЕсли;
	// 17.08.2019 *** ЦПР *** Борисов Проект "Поддержка" Задача № 13291 (окончание)
...
Процедура ДобавитьКартинкуВФорматированныйДокументНаСервере(Картинка)
	
	ПозицияНачала = 0;
	ПозицияОкончания = 0;
	Элементы.ТекстПисьмаФорматированныйДокумент.ПолучитьГраницыВыделения(ПозицияНачала,ПозицияОкончания);
	
	ЭлементКартинки = ТекстПисьмаФорматированныйДокумент.Вставить(ПозицияНачала, Картинка, Тип("КартинкаФорматированногоДокумента")); 
