...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	Если Статус.Вид=Перечисления.ВидыСтатусовЗадач.Отклонена
		Или Статус.Вид=Перечисления.ВидыСтатусовЗадач.Закрыта Тогда
			
		ПроверяемыеРеквизиты.Добавить("КатегорияЗакрытия");
	КонецЕсли;
	
	Если Статус.Вид = Перечисления.ВидыСтатусовЗадач.Закрыта Тогда
		ПроверяемыеРеквизиты.Добавить("ВидОплаты");
		
		Если ВидОплаты = Справочники.ВидыОплатыЗадач.Платная Тогда
			ПроверяемыеРеквизиты.Добавить("ОценкаТрудозатрат");
		КонецЕсли;
	КонецЕсли;
КонецПроцедуры
