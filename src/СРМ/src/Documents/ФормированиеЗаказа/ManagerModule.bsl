...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.МенеджерПечати = "Документ.ФормированиеЗаказа";
...
Функция ПечатьОтчетаПоРаботе(МассивОбъектов, ОбъектыПечати)
	...
	Макет=Документы.ФормированиеЗаказа.ПолучитьМакет("ОтчетПоРаботе");
	...
	|	) КАК Задачи
	|ИЗ
	|	Документ.ФормированиеЗаказа КАК ФормированиеЗаказа
	|ГДЕ
