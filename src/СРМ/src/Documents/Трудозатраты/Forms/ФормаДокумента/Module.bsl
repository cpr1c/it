...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Параметры.Свойство("ИдентификаторТаймера", ИдентификаторТаймера);
	...
	Если ЗначениеЗаполнено(ИдентификаторТаймера) Тогда
		...
		Объект.Предмет=ДанныеТаймера.Предмет;
		Объект.Часов=ДанныеТаймера.Часов;
		Если ЗначениеЗаполнено(ДанныеТаймера.ВидДеятельности) Тогда
			Объект.ВидДеятельности=ДанныеТаймера.ВидДеятельности;
		КонецЕсли;
		Объект.Комментарий = ДанныеТаймера.Комментарий + " " + ДанныеТаймера.Периоды;	
	КонецЕсли;
