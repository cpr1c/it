...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "ИзмененТаймер"
		...
		Элементы.ПолеHTMLТаймеров.Видимость=Источник.КоличествоТаймеров>0;
	КонецЕсли;
...
Процедура УстановитьВидимостьВспомогательныхЭлементовПанелиДействий()
	...
	Элементы.СвернутьПанельДействий.Видимость=ЕстьЗапущенныеТаймеры;
	Элементы.ПолеHTMLТаймеров.Видимость=ЕстьЗапущенныеТаймеры;
КонецПроцедуры
...
&НаКлиенте
Процедура Подключаемый_УчетВремени_ПослеОбновленияПоляТаймеров(ДанныеТаймеров) Экспорт
//	УстановитьВидимостьВспомогательныхЭлементовПанелиДействий(ДанныеТаймеров.КоличествоТаймеров>0);	
КонецПроцедуры
