...
Процедура СформироватьОтчетыПоРаботе(СоответствиеДанныхОтчетовПоРаботам)
	Для Каждого КлючЗначение Из СоответствиеДанныхОтчетовПоРаботам Цикл
		ОтчетПоРаботам = Документы.ОтчетПоРаботамПартнеру.ТекущийОтчетПоРаботамПартнера(КлючЗначение.Ключ, ПериодРегистрации);
		...
		Иначе
			...
			ОтчетПоРаботамОбъект.ПериодРегистрации = ПериодРегистрации;
