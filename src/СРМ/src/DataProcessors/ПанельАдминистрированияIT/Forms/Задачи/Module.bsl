...
&НаКлиенте
Процедура ДатаНачалаФормированияОтчетовПоРаботамПартнерамПриИзменении(Элемент)
	Подключаемый_ПриИзмененииРеквизита(Элемент);
КонецПроцедуры

&НаКлиенте
Процедура ИспользоватьОтчетыПоРаботамПартнерамПриИзменении(Элемент)
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Элементы.ДатаНачалаФормированияОтчетовПоРаботамПартнерам.Доступность = НаборКонстант.ИспользоватьОтчетыПоРаботамПартнерам;
