...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	Если Отказ Тогда
		Возврат;
	КонецЕсли;
	УправлениеЗадачами.СоздатьНовоеПисьмоПоКомментариюЗадачи(ТекущийОбъект);
КонецПроцедуры
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	УправлениеЗадачами.ОтправитьПисьмоПоКомментариюЗадачи(ТекущийОбъект);
КонецПроцедуры
&НаКлиенте
...
Процедура ПредставлениеПолучателейНажатие(Элемент, СтандартнаяОбработка)
	...
	УправлениеЗадачамиКлиент.РедактироватьКопииПолучателейСобытияЗадачи(ПолучателиСообщения,
...
Процедура ПредставлениеПолучателейНажатиеЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ПолучателиСообщения.Очистить();

	Для Каждого Стр Из Результат Цикл
		НС=ПолучателиСообщения.Добавить();
...
Процедура ЗаполнитьПолучателейПоЗадаче()
	...
	Если ЗначениеЗаполнено(Контакт) Тогда
		...
		Если ЗначениеЗаполнено(Адрес) Тогда
			НовыйПолучатель=ПолучателиСообщения.Добавить();
		...
		КонецЕсли;
		ОтправитьСообщениеКонтакту=Истина;
	КонецЕсли;
